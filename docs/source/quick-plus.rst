===================================
MVAPICH-Plus 5.0rc Quick Start Guide
===================================
...
to download, install, and use MVAPICH-Plus 5.0rc.
...
applications. MVAPICH  has support for
...
.. code:: sh
	...
	$ wget http://mvapich.cse.ohio-state.edu/download/mvapich/plus/5.0rc/<mvp-plus-rpm-name>.rpm
...
If you get an error while trying to install this is normally caused by a build of your spec not existing yet.  In this case please fill out this `form <https://mvapich.cse.ohio-state.edu/Plusform/>`_ that will give us information to generate it for you and get you in contact with us.
