======================================
MVAPICH-Plus 5.1.0b Quick Start Guide
======================================
...
to download, install, and use MVAPICH-Plus 5.1.0b.
...
.. code:: sh
	...
	$ wget http://mvapich.cse.ohio-state.edu/download/mvapich/plus/5.1.0b/<mvp-plus-rpm-name>.rpm
