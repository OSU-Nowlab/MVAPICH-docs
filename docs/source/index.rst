Welcome to MVAPICH-Plus documentation!
=======================================
...
Enhanced Ethernet (RoCE v1 and v2), Slingshot 10/11, and Rockport
Networks) and deliver best performance and scalability to MPI
applications. MVAPICH 5.0rc adds support for
...
**MVAPICH-Plus** provides a GPU aware MPI implementation and additional enhancements to increase performance.
